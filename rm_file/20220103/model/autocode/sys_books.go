...
type SysBooks struct {
      ...
      PubDate  *time.Time `json:"pubDate" form:"pubDate" gorm:"column:pub_date;comment:出版时间;size:100;"`
      ...
      Price  *int `json:"price" form:"price" gorm:"column:price;comment:定价;size:10,2;"`
