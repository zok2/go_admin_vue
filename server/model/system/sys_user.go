...
type SysUser struct {
	...
	Address  string `json:"address" form:"address" gorm:"column:address;comment:;size:200;"`
	...
	Telephone  string `json:"telephone" form:"telephone" gorm:"column:telephone;comment:;size:20;"`
}
